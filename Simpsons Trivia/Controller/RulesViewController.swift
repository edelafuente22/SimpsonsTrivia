...
class RulesViewController: UIViewController, UITextViewDelegate {
    ...
    func rulesText() -> NSAttributedString {
        ...
        attributedString.addAttribute(.link, value: "mailto:woohootrivia@gmail.com", range: string.range(of: "email link"))
