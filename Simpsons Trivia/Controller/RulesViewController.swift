...
class RulesViewController: UIViewController, UITextViewDelegate {
    ...
    func rulesText() -> NSAttributedString {
        ...
        attributedString.addAttributes(boldFontAttribute, range: string.range(of: "Then why did you make this game?"))
