...
class QuestionViewController: UIViewController, GKGameCenterControllerDelegate {
    ...
    func updateHeader(){
        ...
        questionCounter.text = "Q\(questionCount + 1)/12"
